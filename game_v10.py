...
moonX = 400 + random.randint(100, 400)
moonY = random.randint(20, 110)
...
def reset():
    global cloud_position_list, star0X, star0Y, star1X, star1Y, moonX, moonY, speed, dino_x, dino_y, jump_speed, is_jumping, count, count1, which_barrier, barrier_x, gaming, score, restart_delay, is_day
    score = 0
    cloud_position_list = [[600, random.randint(20, 150)], [600 + random.randint(100, 400), random.randint(20, 150)], [850 + random.randint(100, 400), random.randint(20, 150)]]
    star0X = random.randint(100, 400)
    star0Y = random.randint(20, 150)
...
def day_night():
    global score, switch_cooldown, day_night_switch_state, is_day, moonX, bg_colour, bg, cloud_image, game_over_image, HI, restart, cactus_list, dino_list, bright_number_list, dark_number_list

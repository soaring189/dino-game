...
def barrier():
    global which_barrier, cactus_list, barrier_x, speed, gaming
    if gaming:
        barrier_x -= speed
    if which_barrier == 0:
        barrier_y = 193
...
def precompute_image():
    global bg, cloud_image, game_over_image, HI, restart, cactus0, cactus1, cactus2, cactus3, cactus4, dino_list, bright_number_list, dark_number_list, bg_day, bg_night, cloud_day, cloud_night, game_over_day, game_over_night, HI_day, HI_night, restart_day, restart_night, cactus_day, cactus_night, dino_day, dino_night, bright_number_list_day, bright_number_list_night, dark_number_list_day, dark_number_list_night
    bg_day, bg_night = bg.copy(), invert_colors(bg)
    cloud_day, cloud_night = cloud_image.copy(), invert_colors(cloud_image)
...
def day_night():
    global score, switch_cooldown, day_night_switch_state, is_day, bg_colour, bg, cloud_image, game_over_image, HI, restart, cactus_list, dino_list, bright_number_list, dark_number_list

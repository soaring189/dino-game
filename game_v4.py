...
cactus0 = p.transform.scale(p.image.load("./Assets/cactus-0.png").convert_alpha(), (20, 36.5))
cactus1 = p.transform.scale(p.image.load("./Assets/cactus-1.png").convert_alpha(), (34, 59))
cactus2 = p.transform.scale(p.image.load("./Assets/cactus-2.png").convert_alpha(), (43, 43))
cactus3 = p.transform.scale(p.image.load("./Assets/cactus-3.png").convert_alpha(), (69, 44))
cactus4 = p.transform.scale(p.image.load("./Assets/cactus-4.png").convert_alpha(), (90, 70))
...
def barrier():
    global which_barrier, barrier_x, speed
    barrier_x -= speed
    if which_barrier == 0:
        ...
        screen.blit(cactus4, (barrier_x, 170))
    if barrier_x < -50:
        barrier_x = 600
        which_barrier = random.randint(0, 5)
        speed += 0.01
